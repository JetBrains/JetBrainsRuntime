...
/**
 * @test
 * @summary Verifies that window's initial location matches one from getLocationOnScreen()
 * @requires os.family == "linux"
 * @key headful
 * @run main/othervm WLWindowInitialLocation
 */
public class WLWindowInitialLocation {
    private static JFrame frame;
    public static void main(String[] args) throws Exception {
        try {
            SwingUtilities.invokeAndWait(() -> {
                frame = new JFrame("WLWindowInitialLocation Test");
