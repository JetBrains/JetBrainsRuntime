...
jbrsdk_dcevm-${jbsdk_version}-linux-test-x64-b${build_number}.tar.gz
jbrsdk_dcevm-${jbsdk_version}-linux-x64-b${build_number}.tar.gz
jbrsdk_dcevm-${jbsdk_version}-osx-aarch64-b${build_number}.tar.gz
jbrsdk_dcevm-${jbsdk_version}-osx-test-aarch64-b${build_number}.tar.gz
jbrsdk_dcevm-${jbsdk_version}-osx-test-x64-b${build_number}.tar.gz
jbrsdk_dcevm-${jbsdk_version}-osx-x64-b${build_number}.tar.gz
jbrsdk_dcevm-${jbsdk_version}-windows-test-x64-b${build_number}.tar.gz
