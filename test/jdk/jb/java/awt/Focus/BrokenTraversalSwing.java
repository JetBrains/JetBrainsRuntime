...
public class BrokenTraversalSwing {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            SwingUtilities.invokeAndWait(BrokenTraversalSwing::initUI);
            robot.delay(1000);
            clickOn(button1);
            robot.delay(500);
            checkFocus(button1);
    ...
    private static void initUI() {
        frame = new JFrame("BrokenTraversalSwing");
        ...
        b.setFocusTraversalPolicy(new DefaultFocusTraversalPolicy() {
            @Override
