 ...
 * @run main/othervm/timeout=200 -Xlog:gc*=info -Xmx2g -XX:+UseShenandoahGC -XX:+UnlockDiagnosticVMOptions -XX:+UnlockExperimentalVMOptions -XX:ShenandoahGCHeuristics=dynamic      -XX:+ShenandoahVerify TestGCBasherWithShenandoah 120000
