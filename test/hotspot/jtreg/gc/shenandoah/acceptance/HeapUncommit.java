 ...
 * @run main/othervm -XX:+UseShenandoahGC -XX:+UnlockDiagnosticVMOptions -XX:+UnlockExperimentalVMOptions -Xmx2g -XX:ShenandoahUncommitDelay=0 -XX:ShenandoahGCHeuristics=dynamic      -XX:+ShenandoahVerify HeapUncommit
 ...
 * @run main/othervm -XX:+UseShenandoahGC -XX:+UnlockDiagnosticVMOptions -XX:+UnlockExperimentalVMOptions -Xmx2g -XX:ShenandoahUncommitDelay=0 -XX:ShenandoahGCHeuristics=dynamic      HeapUncommit
