 ...
 * <code>com.sun.jdi.VirtualMachineManager.minorInterfaceVersion()</code><BR>
 * complies with its specification.                             <BR>
 * <BR>
 * The test checks up that invoking the method                  <BR>
 *   VirtualMachineManager.minorInterfaceVersion() doesn't throw<BR>
 *  an exception and a returned value is of the int type.       <BR>
 */

public class minor001 {
    ...
    public static int run (String argv[], PrintStream out) {
        return new minor001().runThis(argv, out);
    }
    ...
    //------------------------------------------------------  testing section
        ...
        if (vmm == null) {
            ...
            log2("......call to vmm.minorInterfaceVersion()");
            int minorVersion;
            try {
                minorVersion = vmm.minorInterfaceVersion();
                log2("         minorInterfaceVersion() == " + minorVersion);
            } catch ( Exception e) {
