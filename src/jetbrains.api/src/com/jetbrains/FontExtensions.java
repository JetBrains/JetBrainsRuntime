...
public interface FontExtensions {
    /**
     * The list of all supporting features. For feature description look at
     * https://learn.microsoft.com/en-us/typography/opentype/spec/featurelist
     * Next features: KERN, LIGA, CALT are missing intentionally. This features will be adding automatically via text
     * attributes of Font
     * Adding TextAttribute.KERNING to Font's values will include KERN feature
     * Adding TextAttribute.LIGATURES to Font's values will include LIGA and CALT features
     */
    enum Feature {
