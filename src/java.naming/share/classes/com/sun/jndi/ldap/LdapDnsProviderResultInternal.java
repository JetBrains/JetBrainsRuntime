 ...
 * {@code com.sun.jndi.ldap.spi.LdapDnsProviderResult} known to
 * module java.naming.
 */
public final class LdapDnsProviderResultInternal {
     ...
     */
    public LdapDnsProviderResultInternal(String domainName, List<String> endpoints) {
