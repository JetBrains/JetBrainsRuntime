...
public class JBRApi {
     ...
     */
    public static final boolean ENABLED = Utils.property("jetbrains.api.enabled", true);
    /**
     ...
     */
    static final boolean EXTENSIONS_ENABLED = Utils.property("jetbrains.api.extensions.enabled", true);
    /**
     * Enable extensive debugging logging. Disabled by default.
     */
    static final boolean VERBOSE = Utils.property("jetbrains.api.verbose", false);
    /**
     * Print warnings about usage of deprecated interfaces and methods to {@link System#err}. Enabled by default.
     */
    static final boolean LOG_DEPRECATED = Utils.property("jetbrains.api.logDeprecated", true);
    /**
     * Enable additional verification of generated bytecode. Disabled by default.
     */
    static final boolean VERIFY_BYTECODE = Utils.property("jetbrains.api.verifyBytecode", false);
    ...
    @SuppressWarnings("rawtypes")
    public static void init(InputStream registryStream,
        ...
        proxyRepository = new ProxyRepository(registryStream, serviceAnnotation, providedAnnotation, providesAnnotation);
