...
class ProxyGenerator {
    ...
    ProxyGenerator(ProxyRepository proxyRepository, Proxy.Info info, Mapping[] specialization) {
        ...
        // Data flow check doesn't fully work with COMPUTE_FRAMES on JBR 17
        proxyWriter = JBRApi.VERIFY_BYTECODE ? new CheckClassAdapter(originalProxyWriter, false) : originalProxyWriter;
