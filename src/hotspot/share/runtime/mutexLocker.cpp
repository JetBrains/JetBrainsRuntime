...
Mutex*   JfrEpochShift_lock           = nullptr;
#endif
...
void mutex_init() {
  ...
  MUTEX_DEFN(OOMEStacks_lock                , PaddedMutex  , event); // Must be lower than any other lock as can be used at random during any memory allocation
