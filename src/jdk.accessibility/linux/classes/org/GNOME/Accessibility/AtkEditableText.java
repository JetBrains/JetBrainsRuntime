 ...
 * and the ATK (Accessibility Toolkit) editable text interface used by assistive
 * technologies.
 */
public class AtkEditableText extends AtkText {
    ...
    private AtkEditableText(AccessibleContext ac) {
        ...
        accessibleEditableTextWeakRef = new WeakReference<AccessibleEditableText>(ac.getAccessibleEditableText());
    }
     ...
     * Called from native code via JNI (jaw_editable_text_data_init in jaweditabletext.c).
     *
     ...
     * Called from native code via JNI (jaw_editable_text_set_text_contents in jaweditabletext.c).
     *
     ...
     * Called from native code via JNI (jaw_editable_text_insert_text in jaweditabletext.c).
     *
     ...
     * Called from native code via JNI (jaw_editable_text_copy_text in jaweditabletext.c).
     *
     ...
     * Called from native code via JNI (jaw_editable_text_cut_text in jaweditabletext.c).
     *
     * @param start the start position
     * @param end the end position
     */
     ...
     * Called from native code via JNI (jaw_editable_text_delete_text in jaweditabletext.c).
     *
     * @param start the start position
     * @param end the end position
     */
     ...
     * Called from native code via JNI (jaw_editable_text_paste_text in jaweditabletext.c).
     *
     ...
     * Called from native code via JNI (jaw_editable_text_set_run_attributes in jaweditabletext.c).
     *
