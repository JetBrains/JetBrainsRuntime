...
public class AtkAction {
    ...
    private WeakReference<AccessibleContext> accessibleContextRef;
    private WeakReference<AccessibleAction> accessibleActionRef;
    private WeakReference<AccessibleExtendedComponent> extendedComponentRef;

    private String[] actionDescriptions;
    private String[] actionLocalizedNames;
    private int actionCount; // the number of accessible actions available on the object
    ...
    private AtkAction(AccessibleContext ac) {
        ...
        this.accessibleContextRef = new WeakReference<AccessibleContext>(ac);
        this.accessibleActionRef = new WeakReference<AccessibleAction>(accessibleAction);
        ...
        if (accessibleComponent instanceof AccessibleExtendedComponent accessibleExtendedComponent) {
            this.extendedComponentRef = new WeakReference<AccessibleExtendedComponent>(accessibleExtendedComponent);
        }
    }
    ...
    private boolean do_action(int index) {
        ...
        AccessibleAction accessibleAction = accessibleActionRef.get();
        if (accessibleAction == null)
            return false;
    ...
    private String get_localized_name(int index) {
        ...
        AccessibleContext accessibleContext = accessibleContextRef.get();
