...
public class AtkText {
    ...
    private Rectangle get_character_extents(int offset, int coordType) {
        ...
        return AtkUtil.invokeInSwingAndWait(() -> {
            ...
            Point componentLocation = AtkComponent.getLocationByCoordinateType(ac, component, coordType);
    ...
    private int get_offset_at_point(int x, int y, int coord_type) {
        ...
        return AtkUtil.invokeInSwingAndWait(() -> {
            ...
            Point componentLocation = AtkComponent.getLocationByCoordinateType(ac, component, coord_type);
            if (componentLocation == null) {
                return -1;
            }
