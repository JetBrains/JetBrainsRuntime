 ...
 * and the ATK (Accessibility Toolkit) image interface used by assistive
 * technologies. AtkImage should be implemented by components which display
...
public class AtkImage {
    ...
    private Point get_image_position(int coordType) {
        ...
        return AtkUtil.invokeInSwingAndWait(() -> {
            ...
            return AtkComponent.getLocationByCoordinateType(ac, accessibleComponent, coordType);
        }, null);
    }
