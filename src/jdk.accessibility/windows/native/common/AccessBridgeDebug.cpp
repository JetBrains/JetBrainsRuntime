...
void initializeFileLogger(const char * const fileName) {
 ...
 */
char *printError(const char * const msg) {
     ...
     */
    void PrintDebugString(const char * const msg, ...) {
#ifdef DEBUGGING_ON
        char buf[1024] = {0};
        va_list argprt;
     ...
     */
    void PrintJavaDebugString2(const char * const msg, ...) {
     ...
     */
    void wPrintDebugString(const wchar_t * const msg, ...) {
#ifdef DEBUGGING_ON
        char buf[1024] = {0};
        char charmsg[256];
        va_list argprt;
     ...
     */
    void wPrintJavaDebugString(const wchar_t * const msg, ...) {
#ifdef JAVA_DEBUGGING_ON
        char buf[1024] = {0};
        char charmsg[256] = {0};
        va_list argprt;
