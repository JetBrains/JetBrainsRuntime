...
static void zwp_primary_selection_source_handle_send(void* user, struct zwp_primary_selection_source_v1* source,
...
static void zwp_primary_selection_offer_handle_offer(void* user, struct zwp_primary_selection_offer_v1* offer,
                                                     const char* mime);
...
static void wl_data_device_handle_data_offer(void* user, struct wl_data_device* wl_data_device,
                                             struct wl_data_offer* id);
static void wl_data_device_handle_enter(void* user, struct wl_data_device* wl_data_device,
...
static void wl_data_device_handle_motion(void* user, struct wl_data_device* wl_data_device,
                                         uint32_t time, wl_fixed_t x, wl_fixed_t y);
static void wl_data_device_handle_drop(void* user, struct wl_data_device* wl_data_device);
static void wl_data_device_handle_selection(void* user, struct wl_data_device* wl_data_device,
                                            struct wl_data_offer* id);
...
static void zwp_primary_selection_device_handle_data_offer(void* user, struct zwp_primary_selection_device_v1* device,
                                                           struct zwp_primary_selection_offer_v1* id);
static void zwp_primary_selection_device_handle_selection(void* user, struct zwp_primary_selection_device_v1* device,
                                                          struct zwp_primary_selection_offer_v1* id);
...
static void DataOffer_callSelectionHandler(struct DataOffer* offer);
...
static struct DataOffer* DataOffer_create(enum DataTransferProtocol protocol, void* waylandObject)
{
    ...
    if (protocol == DATA_TRANSFER_PROTOCOL_PRIMARY_SELECTION) {
        ...
        zwp_primary_selection_offer_v1_add_listener(zwpPrimarySelectionOffer,
                                                    &zwpPrimarySelectionOfferListener,
                                                    offer);
...
static void DataOffer_callSelectionHandler(struct DataOffer* offer)
{
    ...
    (*env)->CallVoidMethod(env, WLDataDeviceObject, WLDataDevice_handleSelectionMID, offer->javaObject,
        offer->protocol == DATA_TRANSFER_PROTOCOL_PRIMARY_SELECTION);
    EXCEPTION_CLEAR(env);
}
...
static void wl_data_source_handle_target(void* user, struct wl_data_source*, const char* mime)
{
...
static void wl_data_source_handle_send(void* user, struct wl_data_source*, const char* mime, int32_t fd)
{
    struct DataSource* source = user;
    assert(source != NULL);
...
static void wl_data_source_handle_cancelled(void* user, struct wl_data_source*)
{
    struct DataSource* source = user;
    assert(source != NULL);
...
static void wl_data_source_handle_dnd_drop_performed(void* user, struct wl_data_source*)
{
    struct DataSource* source = user;
    assert(source != NULL);
...
static void wl_data_source_handle_dnd_finished(void* user, struct wl_data_source*)
{
    struct DataSource* source = user;
    assert(source != NULL);
...
static void wl_data_source_handle_action(void* user, struct wl_data_source*, uint32_t action)
{
    struct DataSource* source = user;
    assert(source != NULL);
...
static void zwp_primary_selection_source_handle_send(void* user, struct zwp_primary_selection_source_v1*,
                                                     const char* mime, int32_t fd)
{
    struct DataSource* source = user;
    assert(source != NULL);
...
static void zwp_primary_selection_source_handle_cancelled(void* user, struct zwp_primary_selection_source_v1*)
{
    struct DataSource* source = user;
    assert(source != NULL);
...
static void wl_data_offer_handle_offer(void* user, struct wl_data_offer*, const char* mime)
{
    DataOffer_callOfferHandler((struct DataOffer*)user, mime);
}

static void zwp_primary_selection_offer_handle_offer(void* user, struct zwp_primary_selection_offer_v1*,
                                                     const char* mime)
{
    DataOffer_callOfferHandler((struct DataOffer*)user, mime);
}

static void wl_data_device_handle_data_offer(void*, struct wl_data_device*, struct wl_data_offer* id)
{
    ...
    wl_data_offer_add_listener(id, &wlDataOfferListener, offer);
}

static void wl_data_device_handle_selection(void*, struct wl_data_device*,
                                            struct wl_data_offer* id)
{
    // TODO
}

static void zwp_primary_selection_device_handle_data_offer(void* user, struct zwp_primary_selection_device_v1*,
                                                           struct zwp_primary_selection_offer_v1* id)
{
    ...
    zwp_primary_selection_offer_v1_add_listener(id, &zwpPrimarySelectionOfferListener, offer);
}

static void zwp_primary_selection_device_handle_selection(void*, struct zwp_primary_selection_device_v1*,
                                                          struct zwp_primary_selection_offer_v1* id)
{
    // TODO
}
...
Java_sun_awt_wl_WLDataDevice_initNative(
    JNIEnv* env,
    jobject obj)
{
    if (!initJavaRefs(env)) {
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLDataDevice_dispatchDataTransferQueueImpl(
    JNIEnv* env,
    jclass clazz)
{
...
Java_sun_awt_wl_WLDataSource_createImpl(
    JNIEnv* env,
    jclass wlDataSourceClass,
    jint protocol)
{
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLDataSource_bindNative(
    JNIEnv* env,
    jclass clazz,
    jlong nativePtr,
    jobject javaObject)
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLDataSource_offerMimeImpl(
    JNIEnv* env,
    jclass clazz,
    jlong nativePtr,
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLDataSource_destroyImpl(
    JNIEnv* env,
    jclass clazz,
    jlong nativePtr)
{
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLDataSource_setDnDActionsImpl(
    JNIEnv* env,
    jclass clazz,
    jlong nativePtr,
    jint actions)
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLDataSource_setSelectionImpl(
    JNIEnv* env,
    jclass clazz,
    jlong nativePtr,
    jlong serial)
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLDataOffer_destroyImpl(
    JNIEnv* env,
    jclass clazz,
    jlong nativePtr)
{
...
Java_sun_awt_wl_WLDataOffer_openReceivePipe(
    JNIEnv* env,
    jclass clazz,
    jlong nativePtr,
    jstring mimeJavaString)
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_WLDataOffer_finishDnDImpl(
    JNIEnv* env,
    jclass clazz,
    jlong nativePtr)
{
