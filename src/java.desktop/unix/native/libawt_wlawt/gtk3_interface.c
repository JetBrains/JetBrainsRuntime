...
static void transform_detail_string (const gchar *detail, GtkStyleContext *context);
static void gtk3_init(GtkApi* gtk);

static jmp_buf gtk_init_exit;
...
static void* dl_symbol(const char* name)
{
    ...
    if (!result)
        longjmp(gtk_init_exit, NO_SYMBOL_EXCEPTION);
...
static void update_supported_actions(JNIEnv *env) {
    ...
    jclass cls_DesktopPeer = (*env)->FindClass(env, "sun/awt/wl/WLDesktopPeer");
    CHECK_NULL(cls_DesktopPeer);
    jfieldID fld_supportedActions = (*env)->GetStaticFieldID(env,
                      cls_DesktopPeer, "supportedActions", "Ljava/util/List;");
    CHECK_NULL(fld_supportedActions);
    jobject supportedActions = (*env)->GetStaticObjectField(env, cls_DesktopPeer, fld_supportedActions);
...
static void gtk3_file_chooser_load()
{
    ...
    fp_gtk_file_chooser_set_current_name = dl_symbol("gtk_file_chooser_set_current_name");
    ...
    fp_gtk_file_chooser_get_current_folder = dl_symbol("gtk_file_chooser_get_current_folder");
    fp_gtk_file_chooser_get_filenames = dl_symbol("gtk_file_chooser_get_filenames");
...
GtkApi* gtk3_load(JNIEnv *env, const char* lib_name)
{
    ...
    if (setjmp(gtk_init_exit) == 0)
    {
        ...
        fp_gdk_pixbuf_new_from_file = dl_symbol("gdk_pixbuf_new_from_file");
        ...
        fp_gdk_pixbuf_get_rowstride = dl_symbol("gdk_pixbuf_get_rowstride");
        fp_gdk_pixbuf_get_has_alpha = dl_symbol("gdk_pixbuf_get_has_alpha");
        fp_gdk_pixbuf_get_bits_per_sample = dl_symbol("gdk_pixbuf_get_bits_per_sample");
        fp_gdk_pixbuf_get_n_channels = dl_symbol("gdk_pixbuf_get_n_channels");
        fp_gdk_pixbuf_get_colorspace = dl_symbol("gdk_pixbuf_get_colorspace");
        ...
        fp_cairo_image_surface_get_data = dl_symbol("cairo_image_surface_get_data");
        fp_cairo_image_surface_get_stride = dl_symbol("cairo_image_surface_get_stride");

        fp_gdk_pixbuf_get_from_surface = dl_symbol("gdk_pixbuf_get_from_surface");
        ...
        fp_gtk_widget_get_style_context = dl_symbol("gtk_widget_get_style_context");
        fp_gtk_style_context_get_color = dl_symbol("gtk_style_context_get_color");
        ...
        fp_gtk_style_context_set_state = dl_symbol("gtk_style_context_set_state");
        fp_gtk_style_context_add_class = dl_symbol("gtk_style_context_add_class");
        ...
        fp_gtk_widget_render_icon_pixbuf = dl_symbol("gtk_widget_render_icon_pixbuf");
        fp_gdk_window_create_similar_image_surface = dl_symbol("gdk_window_create_similar_image_surface");
        ...
        fp_gtk_settings_get_for_screen = dl_symbol("gtk_settings_get_for_screen");
        ...
        fp_gtk_style_context_add_provider = dl_symbol("gtk_style_context_add_provider");
        ...
        fp_gtk_style_context_get_property = dl_symbol("gtk_style_context_get_property");
        fp_gtk_scrolled_window_set_shadow_type = dl_symbol("gtk_scrolled_window_set_shadow_type");
        ...
        fp_gtk_widget_get_allocated_width = dl_symbol("gtk_widget_get_allocated_width");
        fp_gtk_widget_get_allocated_height = dl_symbol("gtk_widget_get_allocated_height");
        ...
        fp_gtk_adjustment_set_page_increment = dl_symbol("gtk_adjustment_set_page_increment");
        fp_gtk_adjustment_set_page_size = dl_symbol("gtk_adjustment_set_page_size");
        fp_gtk_adjustment_set_step_increment = dl_symbol("gtk_adjustment_set_step_increment");
        ...
        fp_gtk_style_context_has_class = dl_symbol("gtk_style_context_has_class");

        fp_gtk_style_context_set_junction_sides = dl_symbol("gtk_style_context_set_junction_sides");
        fp_gtk_style_context_add_region = dl_symbol("gtk_style_context_add_region");
        ...
        fp_gtk_check_menu_item_new = dl_symbol("gtk_check_menu_item_new");
        fp_gtk_color_selection_dialog_new = dl_symbol("gtk_color_selection_dialog_new");
        ...
        fp_gtk_menu_item_set_submenu = dl_symbol("gtk_menu_item_set_submenu");
        fp_gtk_notebook_new = dl_symbol("gtk_notebook_new");
        fp_gtk_progress_bar_new = dl_symbol("gtk_progress_bar_new");
        fp_gtk_progress_bar_set_orientation = dl_symbol("gtk_orientable_set_orientation");
        fp_gtk_radio_button_new = dl_symbol("gtk_radio_button_new");
        fp_gtk_radio_menu_item_new = dl_symbol("gtk_radio_menu_item_new");
        fp_gtk_scrolled_window_new = dl_symbol("gtk_scrolled_window_new");
        fp_gtk_separator_menu_item_new = dl_symbol("gtk_separator_menu_item_new");
        fp_gtk_text_view_new = dl_symbol("gtk_text_view_new");
        fp_gtk_toggle_button_new = dl_symbol("gtk_toggle_button_new");
        ...
        fp_gtk_menu_shell_append = dl_symbol("gtk_menu_shell_append");
        fp_gtk_widget_realize = dl_symbol("gtk_widget_realize");
        fp_gtk_widget_destroy = dl_symbol("gtk_widget_destroy");
        fp_gtk_widget_render_icon = dl_symbol("gtk_widget_render_icon");
        fp_gtk_widget_set_name = dl_symbol("gtk_widget_set_name");
        fp_gtk_widget_set_parent = dl_symbol("gtk_widget_set_parent");
        fp_gtk_widget_set_direction = dl_symbol("gtk_widget_set_direction");
        fp_gtk_widget_style_get = dl_symbol("gtk_widget_style_get");
        fp_gtk_widget_class_install_style_property = dl_symbol("gtk_widget_class_install_style_property");
        fp_gtk_widget_class_find_style_property = dl_symbol("gtk_widget_class_find_style_property");
        fp_gtk_widget_style_get_property = dl_symbol("gtk_widget_style_get_property");
        fp_pango_font_description_to_string = dl_symbol("pango_font_description_to_string");
        fp_gtk_settings_get_default = dl_symbol("gtk_settings_get_default");
        fp_gtk_widget_get_settings = dl_symbol("gtk_widget_get_settings");
        ...
        fp_gtk_combo_box_entry_new = dlsym(gtk3_libhandle, "gtk_combo_box_new_with_entry");
        fp_gtk_separator_tool_item_new = dlsym(gtk3_libhandle, "gtk_separator_tool_item_new");
    ...
    */
    ...
    if (result) {
        GtkApi* gtk = malloc(sizeof(GtkApi));
        gtk3_init(gtk);
        return gtk;
    }
    return NULL;
 ...
 * buffer.
 *
 * The return value is the transparency type of the resulting image.
 */
                                                      ...
                                                      GtkShadowType shadow_type)
{
    ...
    {
        gtk3_widgets[_GTK_ARROW_TYPE] = (*fp_gtk_arrow_new)(arrow_type, shadow_type);
        (*fp_gtk_container_add)((GtkContainer *)gtk3_fixed, gtk3_widgets[_GTK_ARROW_TYPE]);
...
{
    return (GtkAdjustment *) (*fp_gtk_adjustment_new)(50.0, 0.0, 100.0, 10.0, 20.0, 20.0);
}

/**
 * Returns a pointer to the cached native widget for the specified widget type.
 */
static GtkWidget *gtk3_get_widget(WidgetType widget_type)
{
    ...
    switch (widget_type)
    {
        ...
        case CHECK_BOX:
            ...
            {
                gtk3_widgets[_GTK_CHECK_BUTTON_TYPE] = (*fp_gtk_check_button_new)();
            }
        ...
        case CHECK_BOX_MENU_ITEM:
            ...
            {
                gtk3_widgets[_GTK_CHECK_MENU_ITEM_TYPE] = (*fp_gtk_check_menu_item_new)();
            }
...
/*        case COLOR_CHOOSER:
        ...
        case COMBO_BOX:
            ...
            {
                gtk3_widgets[_GTK_COMBO_BOX_TYPE] = (*fp_gtk_combo_box_new)();
            }
        ...
        case COMBO_BOX_ARROW_BUTTON:
            ...
            {
                gtk3_widgets[_GTK_COMBO_BOX_ARROW_BUTTON_TYPE] = (*fp_gtk_toggle_button_new)();
            }
        ...
        case COMBO_BOX_TEXT_FIELD:
            ...
            {
                result = gtk3_widgets[_GTK_COMBO_BOX_TEXT_FIELD_TYPE] = (*fp_gtk_entry_new)();
            }
        ...
        case LABEL:
            ...
            {
                gtk3_widgets[_GTK_LABEL_TYPE] = (*fp_gtk_label_new)(NULL);
            }
        ...
        case ROOT_PANE:
            if (init_result = (NULL == gtk3_widgets[_GTK_CONTAINER_TYPE]))
            {
                 ...
                 * constructor.
                 */
                gtk3_widgets[_GTK_CONTAINER_TYPE] = (*fp_gtk_fixed_new)();
            }
        ...
        case TEXT_PANE:
            ...
            {
                gtk3_widgets[_GTK_TEXT_VIEW_TYPE] = (*fp_gtk_text_view_new)();
            }
        ...
        case TEXT_FIELD:
            ...
            {
                gtk3_widgets[_GTK_ENTRY_TYPE] = (*fp_gtk_entry_new)();
            }
        ...
        case HANDLE_BOX:
            ...
            {
                gtk3_widgets[_GTK_HANDLE_BOX_TYPE] = (*fp_gtk_handle_box_new)();
            }
        ...
        case HSCROLL_BAR_THUMB:
            ...
            {
                gtk3_widgets[_GTK_HSCROLLBAR_TYPE] = (*fp_gtk_hscrollbar_new)(create_adjustment());
            }
        ...
        case HSEPARATOR:
            ...
            {
                gtk3_widgets[_GTK_HSEPARATOR_TYPE] = (*fp_gtk_hseparator_new)();
            }
        ...
        case INTERNAL_FRAME:
            ...
            {
                gtk3_widgets[_GTK_WINDOW_TYPE] = (*fp_gtk_window_new)(GTK_WINDOW_TOPLEVEL);
            }
        ...
        case TREE_CELL:
            ...
            {
                gtk3_widgets[_GTK_TREE_VIEW_TYPE] = (*fp_gtk_tree_view_new)();
            }
        ...
        case POPUP_MENU:
            ...
            {
                gtk3_widgets[_GTK_MENU_TYPE] = (*fp_gtk_menu_new)();
            }
        ...
        case MENU_ITEM_ACCELERATOR:
            ...
            {
                gtk3_widgets[_GTK_MENU_ITEM_TYPE] = (*fp_gtk_menu_item_new)();
            }
        ...
        case MENU_BAR:
            ...
            {
                gtk3_widgets[_GTK_MENU_BAR_TYPE] = (*fp_gtk_menu_bar_new)();
            }
        ...
        case OPTION_PANE:
            ...
            {
                gtk3_widgets[_GTK_DIALOG_TYPE] = (*fp_gtk_dialog_new)();
            }
        ...
        case POPUP_MENU_SEPARATOR:
            ...
            {
                gtk3_widgets[_GTK_SEPARATOR_MENU_ITEM_TYPE] = (*fp_gtk_separator_menu_item_new)();
            }
        ...
        case HPROGRESS_BAR:
            ...
            {
                gtk3_widgets[_GTK_HPROGRESS_BAR_TYPE] = (*fp_gtk_progress_bar_new)();
            }
        ...
        case VPROGRESS_BAR:
            ...
            {
                gtk3_widgets[_GTK_VPROGRESS_BAR_TYPE] = (*fp_gtk_progress_bar_new)();
                /*
        ...
        case RADIO_BUTTON:
            ...
            {
                gtk3_widgets[_GTK_RADIO_BUTTON_TYPE] = (*fp_gtk_radio_button_new)(NULL);
            }
            result = gtk3_widgets[_GTK_RADIO_BUTTON_TYPE];
            break;
        case RADIO_BUTTON_MENU_ITEM:
            if (init_result = (NULL == gtk3_widgets[_GTK_RADIO_MENU_ITEM_TYPE]))
            {
                gtk3_widgets[_GTK_RADIO_MENU_ITEM_TYPE] = (*fp_gtk_radio_menu_item_new)(NULL);
            }
            result = gtk3_widgets[_GTK_RADIO_MENU_ITEM_TYPE];
            break;
        case SCROLL_PANE:
            if (init_result = (NULL == gtk3_widgets[_GTK_SCROLLED_WINDOW_TYPE]))
            {
                gtk3_widgets[_GTK_SCROLLED_WINDOW_TYPE] = (*fp_gtk_scrolled_window_new)(NULL, NULL);
            }
        ...
        case SPINNER_TEXT_FIELD:
            ...
            {
                result = gtk3_widgets[_GTK_SPIN_BUTTON_TYPE] = (*fp_gtk_spin_button_new)(NULL, 0, 0);
            }
        ...
        case TABBED_PANE_TAB:
            ...
            {
                gtk3_widgets[_GTK_NOTEBOOK_TYPE] = (*fp_gtk_notebook_new)();
            }
        ...
        case TOGGLE_BUTTON:
            ...
            {
                gtk3_widgets[_GTK_TOGGLE_BUTTON_TYPE] = (*fp_gtk_toggle_button_new)();
            }
        ...
        case TOOL_BAR_DRAG_WINDOW:
            ...
            {
                gtk3_widgets[_GTK_TOOLBAR_TYPE] = (*fp_gtk_toolbar_new)();
            }
        ...
        case TOOL_BAR_SEPARATOR:
            ...
            {
                gtk3_widgets[_GTK_SEPARATOR_TOOL_ITEM_TYPE] = (*fp_gtk_separator_tool_item_new)();
            }
        ...
        case VIEWPORT:
            if (init_result = (NULL == gtk3_widgets[_GTK_VIEWPORT_TYPE]))
            {
                ...
                gtk3_widgets[_GTK_VIEWPORT_TYPE] = (*fp_gtk_viewport_new)(adjustment, adjustment);
            }
        ...
        case VSCROLL_BAR_THUMB:
            ...
            {
                gtk3_widgets[_GTK_VSCROLLBAR_TYPE] = (*fp_gtk_vscrollbar_new)(create_adjustment());
            }
        ...
        case VSEPARATOR:
            ...
            {
                gtk3_widgets[_GTK_VSEPARATOR_TYPE] = (*fp_gtk_vseparator_new)();
            }
        ...
        case VSLIDER_TRACK:
            ...
            {
                gtk3_widgets[_GTK_VSCALE_TYPE] = (*fp_gtk_scale_new)(GTK_ORIENTATION_VERTICAL, NULL);
            }
        ...
        gint x, gint y, gint width, gint height, GtkOrientation orientation)
{
    ...
    if (!(strcmp(detail, "paned") == 0)) {
        ...
        if (orientation == GTK_ORIENTATION_VERTICAL) {
            fp_gtk_render_handle(context, cr, x + width / 2.0, y, 2, height);
            fp_gtk_render_background(context, cr, x + width / 2.0, y, 2, height);
        } else {
            fp_gtk_render_handle(context, cr, x, y + height / 2.0, width, 2);
            fp_gtk_render_background(context, cr, x, y + height / 2.0, width, 2);
        }
    }
...
static jboolean gtk3_get_icon_data(JNIEnv *env, gint widget_type,
                              ...
                              jmethodID icon_upcall_method, jobject this) {
    GdkPixbuf* pixbuf = gtk3_get_stock_icon(widget_type, stock_id, size, direction, detail);
    return gtk3_get_pixbuf_data(env, pixbuf, icon_upcall_method, this);
}
                              ...
                              GtkStateType state_type, ColorType color_type)
{
    ...
    if (widget_type == CHECK_BOX_MENU_ITEM || widget_type == RADIO_BUTTON_MENU_ITEM) {
