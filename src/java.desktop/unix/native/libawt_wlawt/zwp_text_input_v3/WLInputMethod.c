...
#include "sun_awt_wl_im_zwp_text_input_v3_WLInputMethodDescriptorZwpTextInputV3.h"
#include "sun_awt_wl_im_zwp_text_input_v3_WLInputMethodZwpTextInputV3.h"
...
static struct
{
    ...
    /// `sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3#zwp_text_input_v3_onEnter`
    jmethodID mID_tiOnEnter;
    /// `sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3#zwp_text_input_v3_onLeave`
    jmethodID mID_tiOnLeave;
    /// `sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3#zwp_text_input_v3_onPreeditString`
    jmethodID mID_tiOnPreeditString;
    /// `sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3#zwp_text_input_v3_onCommitString`
    jmethodID mID_tiOnCommitString;
    /// `sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3#zwp_text_input_v3_onDeleteSurroundingText`
    jmethodID mID_tiOnDeleteSurroundingText;
    /// `sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3#zwt_text_input_v3_onDone`
...
/**
 * The native-side counterpart of `sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3`.
...
struct IMContext
{
    /// A global reference to the instance of `sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3` owning this instance of `IMContext`.
 ...
 *
 * @param wlInputMethodOwnerRefToCopy a reference to the owning instance of `sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3`.
...
static struct IMContext* IMContext_Create(JNIEnv * const env, jobject wlInputMethodOwnerRefToCopy)
{
    ...
    //   the constructor of `sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3` finishes (because the constructor gets called on the
...
Java_sun_awt_wl_im_zwp_1text_1input_1v3_WLInputMethodDescriptorZwpTextInputV3_checkIfAvailableOnPlatform(JNIEnv * const env, const jclass clazz)
{
...
Java_sun_awt_wl_im_zwp_1text_1input_1v3_WLInputMethodZwpTextInputV3_initIDs(JNIEnv * const env, const jclass clazz)
{
    CHECK_NULL_THROW_OOME(
        env,
        jniIDs.wlInputMethodClass = (*env)->NewGlobalRef(env, clazz),
        "Allocation of a global reference to sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3 class failed"
    );
...
Java_sun_awt_wl_im_zwp_1text_1input_1v3_WLInputMethodZwpTextInputV3_createNativeContext(JNIEnv * const env, const jobject self)
{
    struct IMContext *result = NULL;

    if (!checkIfTheImplementationIsAvailable())
    {
        JNU_ThrowByName(env, "java/awt/AWTException", "sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3 is not supported on this system");
        return 0;
    }
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_im_zwp_1text_1input_1v3_WLInputMethodZwpTextInputV3_disposeNativeContext(
    JNIEnv * const env,
    const jclass clazz,
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_im_zwp_1text_1input_1v3_WLInputMethodZwpTextInputV3_zwp_1text_1input_1v3_1enable(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr
) {
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_im_zwp_1text_1input_1v3_WLInputMethodZwpTextInputV3_zwp_1text_1input_1v3_1disable(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr
) {
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_im_zwp_1text_1input_1v3_WLInputMethodZwpTextInputV3_zwp_1text_1input_1v3_1set_1cursor_1rectangle(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr,
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_im_zwp_1text_1input_1v3_WLInputMethodZwpTextInputV3_zwp_1text_1input_1v3_1set_1content_1type(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr,
    const jint hint,
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_im_zwp_1text_1input_1v3_WLInputMethodZwpTextInputV3_zwp_1text_1input_1v3_1set_1text_1change_1cause(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr,
...
JNIEXPORT void JNICALL
Java_sun_awt_wl_im_zwp_1text_1input_1v3_WLInputMethodZwpTextInputV3_zwp_1text_1input_1v3_1commit(
    JNIEnv * const env,
    const jobject self,
    const jlong contextPtr
) {
