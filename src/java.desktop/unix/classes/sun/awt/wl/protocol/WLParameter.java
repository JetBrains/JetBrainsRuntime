...
import static sun.awt.wl.protocol.WLNative.c_string;
import static sun.awt.wl.protocol.WLNative.int32_t;
import static sun.awt.wl.protocol.WLNative.uint32_t;
...
import static sun.awt.wl.protocol.WLNative.wl_fixed_t;
...
public abstract sealed class WLParameter {
    ...
    public static final class IntParameter extends WLParameter {
        ...
        @Override
        public MemoryLayout getArgumentLayout() {
            return int32_t;
        }
    ...
    abstract public MemoryLayout getArgumentLayout();
