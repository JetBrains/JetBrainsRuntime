...
public final class WLInterface {
    ...
    private List<MethodHandle> eventJavaMethodHandles;
    private List<MethodHandle> eventNativeMethodHandles;
    ...
    private void doInit(
        ...
        this.eventJavaMethodHandles = new ArrayList<>();
        this.eventNativeMethodHandles = new ArrayList<>();
        for (WLMessage event : events) {
            ...
            this.eventJavaMethodHandles.add(handle);
            this.eventNativeMethodHandles.add(event.getNativeMethodHandle());
        }
    }
