...
public final class WLInputMethodDescriptorZwpTextInputV3 implements InputMethodDescriptor {
    ...
    private static final PlatformLogger log = PlatformLogger.getLogger("sun.awt.wl.im.zwp_text_input_v3.WLInputMethodDescriptorZwpTextInputV3");
    ...
    private static void ensureIsAvailableOnPlatform() throws AWTException {
        if (!isAvailableOnPlatform()) {
            throw new AWTException("sun.awt.wl.im.zwp_text_input_v3.WLInputMethodZwpTextInputV3 is not supported on this system");
        }
    }
    ...
    /**
     * This method checks if {@link WLInputMethodDescriptorZwpTextInputV3} can function on this system.
