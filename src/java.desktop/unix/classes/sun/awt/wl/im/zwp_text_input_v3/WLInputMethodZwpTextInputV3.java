...
final class WLInputMethodZwpTextInputV3 extends InputMethodAdapter {
    ...
    public void reconvert() {
        throw new UnsupportedOperationException("The zwp_text_input_v3 protocol doesn't support manual reconvertions");
    }
    ...
    public void setCharacterSubsets(Character.Subset[] subsets) {
        // The zwp_text_input_v3 protocol doesn't support limiting the character set.
    }

    @Override
    public void setCompositionEnabled(boolean enable) {
        // CInputMethod does the same
        throw new UnsupportedOperationException("The zwp_text_input_v3 protocol doesn't support adjusting the composition state.");
    }

    @Override
    public boolean isCompositionEnabled() {
        // CInputMethod does the same
        throw new UnsupportedOperationException("The zwp_text_input_v3 protocol doesn't provide information about the current composition state.");
    }
    ...
    public void endComposition() {
        // The protocol doesn't provide a separate method for ending the composition,
