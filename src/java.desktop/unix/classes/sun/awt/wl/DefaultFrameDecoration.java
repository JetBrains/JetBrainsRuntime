...
public class DefaultFrameDecoration extends FullFrameDecorationHelper {
    ...
    private static final Color ICON_HOVERED_FOREGROUND_DARK = new Color(0x373737);
    ...
    private static final Color CLOSE_ICON_PRESSED_BACKGROUND_DARK = new Color(0x808080);
    ...
    private static final Color CLOSE_ICON_HOVERED_BACKGROUND_DARK = new Color(0x808080);
