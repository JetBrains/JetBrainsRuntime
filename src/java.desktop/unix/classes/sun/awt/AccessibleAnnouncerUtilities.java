...
private static String getVariant(Object conf) {
    ...
    return JSONParser.getStringValue(conf, PROFILES_KEY, moduleName, VOICES_KEY, DEFAULT_KEY, FAMILY_KEY, VARIANT_KEY);
}
...
private static String getDialect(Object conf) {
    ...
    return JSONParser.getStringValue(conf, PROFILES_KEY, moduleName, VOICES_KEY, DEFAULT_KEY, FAMILY_KEY, DIALECT_KEY);
}
...
private static double getAveragePitch(Object conf) {
    ...
    Double val = JSONParser.getDoubleValue(conf, PROFILES_KEY, moduleName, VOICES_KEY, DEFAULT_KEY, AVERAGE_PITCH_KEY);
    if (val != null) return val;
    return -1;
}
