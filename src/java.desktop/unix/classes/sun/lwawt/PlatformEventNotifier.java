...
public interface PlatformEventNotifier {
    ...
    default void notifyKeyEvent(int id, long when, int modifiers, int keyCode, char keyChar, int keyLocation, int extendedKeyCode) {
        notifyKeyEvent(id, when, modifiers, keyCode, keyChar, keyLocation, extendedKeyCode, null);
    }
}
