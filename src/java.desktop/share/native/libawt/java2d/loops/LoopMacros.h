...
#define REGISTER_SRC_MASKFILL(TYPE) \
    ...
    REGISTER_MASKFILL(AnyColor, Clear, TYPE, NAME_SRC_MASKFILL(TYPE)), \
    REGISTER_MASKFILL(AnyPaint, Clear, TYPE, NAME_SRC_MASKFILL(TYPE))
// SRC_MASKFILL serves both Src+AnyColor
// and Clear+AnyColor/AnyPaint by special-case rewriting Clear to Src+Color(0x00000000)
