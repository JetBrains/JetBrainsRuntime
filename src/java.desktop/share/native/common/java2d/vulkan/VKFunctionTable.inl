...
INSTANCE_FUNCTION_TABLE_ENTRY(vkGetPhysicalDeviceFormatProperties);
...
DEVICE_FUNCTION_TABLE_ENTRY(vkQueueWaitIdle);
...
DEVICE_FUNCTION_TABLE_ENTRY(vkCmdCopyBuffer);
