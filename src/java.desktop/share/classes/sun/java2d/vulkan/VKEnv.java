...
public class VKEnv {
    ...
    private static VKDevice[] devices;
    private static VKDevice defaultDevice;

    private static native VKDevice[] initNative(long nativePtr, int deviceNumber);
    ...
    public static Stream<VKDevice> getDevices() {
        if (enabled == null) throw new RuntimeException("Vulkan not initialized");
        final VKDevice first = defaultDevice;
