...
public class OGLGraphicsConfigJbrApi {
    ...
    public static int getPixelFormat(GraphicsConfiguration gc) {
    ...
    private static native int getPixelFormat(long pConfigInfo);
