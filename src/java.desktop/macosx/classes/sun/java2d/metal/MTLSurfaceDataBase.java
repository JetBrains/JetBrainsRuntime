...
/**
 * This class describes an MTL "surface", that is, a region of pixels
 * managed via metal.  An MTLSurfaceDataBase can be tagged with one of three
 * different SurfaceType objects for the purpose of registering loops, etc.
 * This diagram shows the hierarchy of MTL SurfaceTypes:
 *
 *                               Any
 *                             /     \
