...
#define RENDER_LOOP_EXIT(env, className)                                                                    \
    @catch (NSException *e) {                                                                               \
        NSLog(@"%s_flushBuffer: failed op=%s ctx=%p", className, mtlOpCodeToStr(opcode), mtlc);             \
        ...
        JNU_LOG_EVENT(env, "%s_flushBuffer: failed op=%s ctx=%p", className, mtlOpCodeToStr(opcode), mtlc); \
