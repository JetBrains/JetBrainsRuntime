...
// 1. Select vertex+fragment shader (and corresponding pipelineDesc) and set pipelineState
// 2. prepare corresponding vertex and fragment buffers (corresponding to selected shaders)
