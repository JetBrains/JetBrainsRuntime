...
- (NSArray *)accessibilityChildren {
    ...
    if (children == NULL) {
        ...
        NSUInteger childIndex = [self rowNumberInTable] * [[[self accessibilityParent] javaBase] accessibleColCount];
        NSInteger i = childIndex * 2;
        NSInteger n = ([self rowNumberInTable] + 1) * [[[self accessibilityParent] javaBase] accessibleColCount] * 2;
