...
public class Foundation {
  ...
  public static boolean isPackageAtPath(final File file) {
    return file.isDirectory() && isPackageAtPath(file.getPath());
  }
  ...
  public static long getEncodingCode(String encodingName) {
    if (isEmptyOrSpaces(encodingName)) return -1;
  ...
  public static void executeOnMainThread(final boolean withAutoreleasePool, final boolean waitUntilDone, final Runnable runnable) {
    ...
    invoke(runnableObject, "performSelectorOnMainThread:withObject:waitUntilDone:", createSelector("run:"),
           nsString(String.valueOf(ourCurrentRunnableCount)), waitUntilDone);
  ...
  public static class NSRect extends Structure implements Structure.ByValue {
    private static final List<String> __FIELDS = Arrays.asList("origin", "size");
  ...
  public static class NSPoint extends Structure implements Structure.ByValue {
    private static final List<String> __FIELDS = Arrays.asList("x", "y");
  ...
  public static class NSSize extends Structure implements Structure.ByValue {
    private static final List<String> __FIELDS = Arrays.asList("width", "height");
